...
/**
 * Klasa Main, czyli główna klasa dla projectQ.
 * @version     1.1
 * @package     projectQ
...
require_once CONF_ROOT.CONF_CATALOG.'class/FunnyGuildsQueries.class.php';
...
class Main {
    ...
    public function __construct() {
        switch (strtolower(CONF_PLUGIN)) {
            case "openguid":
                $this->queries = new OpenGuildQueries();
                break;
            case "funnyguilds":
                $this->queries = new FunnyGuildsQueries();
                break;
            default:
                $this->queries = new OpenGuildQueries();
                break;
